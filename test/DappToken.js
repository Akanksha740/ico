...
contract('DappToken',function (accounts) {
    ...
    it('allocates the initial supply upon deployment',function(){
        return DappToken.deployed().then(function(instance){
            ...
            assert.equal(adminBalance.toNumber(),1000000,'it allocates the initital supply to the admin account');
        });
    });
    ...
    it('transfers token ownership', function () {
        return DappToken.deployed().then(function (instance) {
            ...
            assert.equal(balance.toNumber(), 750000, 'deducts the amount to the receiving account');
       
        });
    });
  it('approves token for delegated transfer', function(){
      return DappToken.deployed().then(function(instance){
          torkInstance = instance;
